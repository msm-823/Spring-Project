										...
										<div class="">
											<div class="paymentinfo">
												<div class="single-method">
													<h3>Paypal</h3> <input type="radio" name="payment_type" value="Paypal" required/>
													&nbsp;&nbsp;<h3>Credit/Debit Card </h3><input type="radio" name="payment_type" value="Credit/Debit" required/>
												</div>
												<div class="single-method">
